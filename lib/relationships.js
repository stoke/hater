...
relationships.manyToMany = function(First, Second) {
  ...
  First._relationships.hasMany(Second._name);
  Second._relationships.hasMany(First._name);
...
relationships.oneToOne = function(First, Second) {
  ...
  First._relationships.hasOne(Second._name);
  Second._relationships.hasOne(First._name);
