  ...
  query.exec(function(e, v) {
    ...
    if (v) {
      v = v.map(function(x) {
        ...
        if(options.fetch) {
          self.fetch.call(instance, options.fetch, em, e);
        }
...
factoryPrototype.fetch = function(children, emitter, e) {
...
factoryPrototype.save = function(fn) {
  ...
  query.exec(function(e, v) {
    ...
    utile.async.series([self.syncOneToOne.bind(self)],function(err) {
      if(fn) {
