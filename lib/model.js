...
model.extend = function(table, opts, proto) {

  factoryPrototype = utile.mixin(factoryPrototype, proto || {});
  
  // TODO: Move those in another (pre-modelize?) function
  opts.dialect = opts.dialect || 'mysql';
  opts.builder = require('./builders/'+opts.dialect);
  opts.connection = opts.builder.connect(opts.connection);
  Query = opts.builder.Query;
  ...
  Factory = function Factory(props) {
    ...
    this.connection = this._opts.connection;  
  }
